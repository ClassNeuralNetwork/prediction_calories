...
# Carregar dataset
dt = pd.read_csv('/home/usuario/Documentos/projetos/prediction_calories/prediction_calories/dataset/ABBREV.csv')
...
cols_to_transform = ['index', 'NDB_No' ,'Shrt_Desc', 'GmWt_Desc1', 'GmWt_Desc2']
